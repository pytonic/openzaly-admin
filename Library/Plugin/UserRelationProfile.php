...
class UserRelationProfile extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.core.SimpleUserProfile profile = 1;</code>
     * @return \Library\Plugin\SimpleUserProfile
     */
     ...
     *
     * Generated from protobuf field <code>.core.SimpleUserProfile profile = 1;</code>
     * @param \Library\Plugin\SimpleUserProfile $var
     * @return $this
     */
    public function setProfile($var)
    {
        GPBUtil::checkMessage($var, \Library\Plugin\SimpleUserProfile::class);
        $this->profile = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Library\Plugin\UserRelation::class);
        $this->relation = $var;
