...
class HaiPluginListResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *获取插件列表数据
     *
     * Generated from protobuf field <code>repeated .core.PluginProfile plugin = 1;</code>
     */
    private $plugin;
     ...
     *
     * Generated from protobuf field <code>repeated .core.PluginProfile plugin = 1;</code>
     * @param \Library\Plugin\PluginProfile[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlugin($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Library\Plugin\PluginProfile::class);
        $this->plugin = $arr;
